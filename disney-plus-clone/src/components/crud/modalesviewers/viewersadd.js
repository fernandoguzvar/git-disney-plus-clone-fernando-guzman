...
import { Addviewers } from "../../../servicios/index";

function Agregarviewers(props) {
                ...
                <div className="row">
                  <div className="col">
                    ...
                    <input
                      ...
                      value={form.video}
                      onChange={(event) => {
                        changeForm("video", event.target.value);
                      }}
                    />
                  </div>
                </div>
